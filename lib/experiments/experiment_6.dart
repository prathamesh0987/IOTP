...
class Experiment6 extends StatefulWidget {
  @override
  _Experiment2State createState() => _Experiment2State();
}

class _Experiment2State extends State<Experiment6> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sequential Pneumatic Circuit'),
      ),
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Expanded(
              child: Image.asset(
                'assets/experiment_6.png', // Replace with the actual path to your PNG image
